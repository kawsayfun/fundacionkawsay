"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{IO:function(){return query},PL:function(){return getDocs},ad:function(){return getFirestore},ar:function(){return where},hJ:function(){return collection}});var n,i,s,a,o=r(3991),l=r(5538),u=r(6914),c=r(8745),h=r(3172),_=r(4203);r(2601);var d=r(263).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let C={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};let LruParams=class LruParams{static withCacheSize(e){return new LruParams(e,LruParams.DEFAULT_COLLECTION_PERCENTILE,LruParams.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,t,r){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let N="WebChannelConnection";let __PRIVATE_WebChannelConnection=class __PRIVATE_WebChannelConnection extends class{get Co(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Fo=t+"://"+e.host,this.Mo=`projects/${r}/databases/${n}`,this.xo="(default)"===this.databaseId.database?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Oo(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId(),a=this.No(e,t.toUriEncodedString());__PRIVATE_logDebug("RestConnection",`Sending RPC '${e}' ${s}:`,a,r);let o={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(o,n,i),this.Lo(e,a,o,r).then(t=>(__PRIVATE_logDebug("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw __PRIVATE_logWarn("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",r),t})}ko(e,t,r,n,i,s){return this.Oo(e,t,r,n,i)}Bo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+f}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}No(e,t){let r=b[e];return`${this.Fo}/v1/${t}:${r}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,r,n){let i=__PRIVATE_generateUniqueDebugId();return new Promise((s,a)=>{let o=new _.JJ;o.setWithCredentials(!0),o.listenOnce(_.tw.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case _.jK.NO_ERROR:let t=o.getResponseJson();__PRIVATE_logDebug(N,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case _.jK.TIMEOUT:__PRIVATE_logDebug(N,`RPC '${e}' ${i} timed out`),a(new FirestoreError(p.DEADLINE_EXCEEDED,"Request time out"));break;case _.jK.HTTP_ERROR:let r=o.getStatus();if(__PRIVATE_logDebug(N,`RPC '${e}' ${i} failed with status:`,r,"response text:",o.getResponseText()),r>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(p).indexOf(t)>=0?t:p.UNKNOWN}(t.status);a(new FirestoreError(e,t.message))}else a(new FirestoreError(p.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new FirestoreError(p.UNAVAILABLE,"Connection failed."));break;default:fail()}}finally{__PRIVATE_logDebug(N,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);__PRIVATE_logDebug(N,`RPC '${e}' ${i} sending request:`,n),o.send(t,"POST",l,r,15)})}qo(e,t,r){let i=__PRIVATE_generateUniqueDebugId(),s=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,_.UE)(),o=(0,_.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Bo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let c=s.join("");__PRIVATE_logDebug(N,`Creating RPC '${e}' stream ${i}: ${c}`,l);let h=a.createWebChannel(c,l),d=!1,m=!1,f=new __PRIVATE_StreamBridge({Eo:t=>{m?__PRIVATE_logDebug(N,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(d||(__PRIVATE_logDebug(N,`Opening RPC '${e}' stream ${i} transport.`),h.open(),d=!0),__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} sending:`,t),h.send(t))},Ao:()=>h.close()}),__PRIVATE_unguardedEventListen=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return __PRIVATE_unguardedEventListen(h,_.ii.EventType.OPEN,()=>{m||(__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} transport opened.`),f.So())}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.CLOSE,()=>{m||(m=!0,__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} transport closed`),f.Do())}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.ERROR,t=>{m||(m=!0,__PRIVATE_logWarn(N,`RPC '${e}' stream ${i} transport errored:`,t),f.Do(new FirestoreError(p.UNAVAILABLE,"The operation could not be completed")))}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.MESSAGE,t=>{var r;if(!m){let s=t.data[0];s||fail();let a=(null==s?void 0:s.error)||(null===(r=s[0])||void 0===r?void 0:r.error);if(a){__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} received error:`,a);let t=a.status,r=function(e){let t=n[e];if(void 0!==t)return __PRIVATE_mapCodeFromRpcCode(t)}(t),s=a.message;void 0===r&&(r=p.INTERNAL,s="Unknown error status: "+t+" with message "+a.message),m=!0,f.Do(new FirestoreError(r,s)),h.close()}else __PRIVATE_logDebug(N,`RPC '${e}' stream ${i} received:`,s),f.vo(s)}}),__PRIVATE_unguardedEventListen(o,_.ju.STAT_EVENT,t=>{t.stat===_.kN.PROXY?__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===_.kN.NOPROXY&&__PRIVATE_logDebug(N,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{f.bo()},0),f}};function getDocument(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
